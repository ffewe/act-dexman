...
class InsertionPolicy(BasePolicy):
    ...
    def generate_trajectory(self, ts_first):
        ...
        self.left_trajectory = [
            ...
            # {"t": 460, "xyz": meet_xyz + np.array([-0.02, 0, 0]), "quat": gripper_pick_quat_left.elements,"gripper": 0},  # insertion
            # {"t": 500, "xyz": meet_xyz + np.array([-0.02, 0, 0]), "quat": gripper_pick_quat_left.elements, "gripper": 0},  # insertion
        ]
        ...
        self.right_trajectory = [
            ...
            # {"t": 460, "xyz": meet_xyz + np.array([0.02, 0, lift_right]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # insertion
            # {"t": 500, "xyz": meet_xyz + np.array([0.02, 0, lift_right]), "quat": gripper_pick_quat_right.elements, "gripper": 0},  # insertion
