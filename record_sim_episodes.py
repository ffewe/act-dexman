    ...
    for episode_idx in range(num_episodes):
        ...
        for t in range(len(joint_traj)): # note: this will increase episode length by 1
            ...
            if 'peg_force' in ts.observation:
                peg_force = ts.observation['peg_force']
                force_analysis = ts.observation.get('force_analysis', {})
        ...
        with h5py.File(dataset_path + '.hdf5', 'w', rdcc_nbytes=1024 ** 2 * 2) as root:
            ...
            force = obs.create_dataset('force',(max_timesteps,12))
            peg_force = obs.create_dataset('peg_force', (max_timesteps, 3))  
